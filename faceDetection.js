...
video.addEventListener('play', () => {
  ...
  setInterval(async () => {
    ...
    if(detections.length > 1){
      status.innerHTML = "Annomaly 1 Detected "+ detections.length +" user detected"
    }
...
function draw() {
  ...
  if(vol > 0.3)
      status4.innerHTML = "Annomaly 7 Detected user sound detected"
